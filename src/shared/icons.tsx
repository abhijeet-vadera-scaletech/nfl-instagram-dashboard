...
export const IconPhoto = (props: IIconProps) => {
    const { scale = 1, color = '#d82d7e' } = props;
    return (
        <svg width={`${scale * 24}px`} height={`${scale * 24}px`} viewBox="0 0 24 24" fill="none">
            <path
...
export const IconHTML5 = (props: IIconProps) => {
    const { scale = 1, color = '#d82d7e' } = props;
    return (
        <svg width={`${scale * 24}px`} height={`${scale * 24}px`} viewBox="-1.5 0 24 24" fill={color}>
...
export const IconSend = (props: IIconProps) => {
	...
	C30.435,2.304,29.588,1.639,28.835,2.009z" fill={color} />
        </svg>
    );
};

export const IconDisplay = (props: IIconProps) => {
    const { scale = 1, color = '#000' } = props;
    return (
        <svg width={`${scale * 50}px`} height={`${scale * 50}px`} viewBox="0 0 50 50" fill={color}>
            <g id="Layer_1">
...
export const IconAverage = (props: IIconProps) => {
    const { scale = 1, color = '#d82d7e' } = props;
    return (
        <svg width={`${scale * 24}px`} height={`${scale * 24}px`} viewBox="0 0 24 24" fill='none'>
            <path d="M3 3V16.2C3 17.8802 3 18.7202 3.32698 19.362C3.6146 19.9265 4.07354 20.3854 4.63803 20.673C5.27976 21 6.11984 21 7.8 21H21M19 15H7M18 7H7M15 11H7" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    );
};

export const IconVideo = (props: IIconProps) => {
    const { scale = 1, color = '#d82d7e' } = props;
    return (
        <svg width={`${scale * 24}px`} height={`${scale * 24}px`} viewBox="0 0 24 24" fill='none'>
            <path d="M16 10L18.5768 8.45392C19.3699 7.97803 19.7665 7.74009 20.0928 7.77051C20.3773 7.79703 20.6369 7.944 20.806 8.17433C21 8.43848 21 8.90095 21 9.8259V14.1741C21 15.099 21 15.5615 20.806 15.8257C20.6369 16.056 20.3773 16.203 20.0928 16.2295C19.7665 16.2599 19.3699 16.022 18.5768 15.5461L16 14M6.2 18H12.8C13.9201 18 14.4802 18 14.908 17.782C15.2843 17.5903 15.5903 17.2843 15.782 16.908C16 16.4802 16 15.9201 16 14.8V9.2C16 8.0799 16 7.51984 15.782 7.09202C15.5903 6.71569 15.2843 6.40973 14.908 6.21799C14.4802 6 13.9201 6 12.8 6H6.2C5.0799 6 4.51984 6 4.09202 6.21799C3.71569 6.40973 3.40973 6.71569 3.21799 7.09202C3 7.51984 3 8.07989 3 9.2V14.8C3 15.9201 3 16.4802 3.21799 16.908C3.40973 17.2843 3.71569 17.5903 4.09202 17.782C4.51984 18 5.07989 18 6.2 18Z" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    );
};